...
@section('content')
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                @include('seller.partials.sidebar')
                    ...
                    <div class="content-wrapper">
                        <h1 style="text-align: center;" class="page-title">{{ __('Cancelled Orders') }}</h1>
                        <div class="card">
                            <div class="card-body">
                                                    ...
                                                    @foreach($orderdetail as $ordrdtl)
                                                        @if($ordrdtl->status == 'Cancelled')
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="fa fa-eye" style="color: green; text-decoration: none;" data-toggle="tooltip" data-placement="top" title="View Order" href="{{URL::to('/seller/view-order/'.$ordrdtl->id)}}"></a>
                                                                </td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
    ...
    <script>
        ...
        document.title = title + " - Cancelled Orders"
    </script>
@endsection
