                            ...
                            <div class="card-body">
                                <form method="POST" action="{{URL::to('/update-product/'.$product->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="productname" type="text" class="form-control @error('productname') is-invalid @enderror" name="productname" placeholder="Enter the product name" value="{{ $product->productname }}" autocomplete="productname" autofocus>
                                        @error('productname')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="productmodel" type="text" class="form-control @error('productmodel') is-invalid @enderror" name="productmodel" placeholder="Enter the product model" value="{{ $product->productmodel }}" autocomplete="productmodel">
                                        @error('productmodel')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <label for="brand">{{ __('Select Brand (Optional):') }}</label>
                                        <select id="brand" data-live-search="true" name="brand" class="selectpicker @error('brand') is-invalid @enderror">
                                            <option hidden selected value="{{$product->brands->id}}"></option>
                                    ...
                                    <div class="form-group">
                                        <label for="category">{{ __('Select Category (Optional):') }}</label>
                                        <select id="category" data-live-search="true" name="category" class="selectpicker @error('category') is-invalid @enderror">
                                            <option hidden selected value="{{$product->categories->id}}"></option>
                                    ...
                                    <div class="form-group">
                                        <label for="shop">{{ __('Select Shop (Optional):') }}</label>
                                        <select id="shop" name="shop" class="selectpicker @error('shop') is-invalid @enderror">
                                            <option hidden selected value="{{$product->shops->id}}"></option>
                                            @foreach($shop as $shp)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="regularprice" type="text" class="form-control @error('regularprice') is-invalid @enderror" name="regularprice" placeholder="Enter the regular price" value="{{ $product->regularprice }}" autocomplete="regularprice">
                                        @error('regularprice')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="discountedprice" type="text" class="form-control @error('discountedprice') is-invalid @enderror" name="discountedprice" placeholder="Enter the discounted price" value="{{ $product->discountedprice }}" autocomplete="discountedprice">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="productquantity" type="text" class="form-control @error('productquantity') is-invalid @enderror" name="productquantity" placeholder="Enter the product quantity" value="{{ $product->productquantity }}" autocomplete="productquantity">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control p-input @error('productdetail') is-invalid @enderror" id="productdetail" type="text" name="productdetail" rows="5" placeholder="Enter the product details">{{ $product->productdetail }}</textarea>
                                        @error('productdetail')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control p-input @error('productdescription') is-invalid @enderror" id="productdescription" type="text" name="productdescription" rows="5" placeholder="Enter the product specifications">{{ $product->productdescription }}</textarea>
...
<script>
    ...
    document.title = title + " - Edit Product"
</script>
<script>
    var limit = 3;
