            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h3 class="title">{{ __('Your Wishlist') }}</h3>
                    </div>
                </div>
                <div id="store" class="col-md-12">
                	@if($product->count() == 0)
	                	<h5 class="title">{{ __('Your wishlist is empty. Please add some products in your wishlist.') }}</h5>
	                @endif
               		<div class="row">
...
<script>
    ...
    document.title = title + " - Your Wishlist"
