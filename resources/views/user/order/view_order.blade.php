                                            ...
                                            @if(!$orderdetail->reviews()->exists())
                                                <form class="review-form" method="POST" action="{{URL::to('/submit/review/'.$orderdetail->id)}}">
                                                    ...
                                                    @if($orderdetail->status == 'Delivered')
                                                        ...
                                                        <button type="submit" class="primary-btn" style="cursor: pointer; padding: 0; height: 50px; width: 150px; border-radius: 0;">{{ __('Submit') }}</button>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" style="border: 1px solid; margin: 2.5px; width: 120px; text-align: center; border-radius: 0;" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Detail') }}</a>
                                                    </li>
                                                    <li class="nav-item">
