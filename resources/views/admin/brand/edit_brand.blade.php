...
@section('content')
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{URL::to('/update-brand/'.$brand->id)}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="brandname" type="text" class="form-control @error('brandname') is-invalid @enderror" name="brandname" placeholder="Enter the brand name" value="{{$brand->brandname}}" autocomplete="brandname" autofocus>
                                        @error('brandname')
    ...
    <script>
        ...
        document.title = title + " - Edit Brand"
    </script>
@endsection
