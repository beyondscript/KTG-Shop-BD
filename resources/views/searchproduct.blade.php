			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb-tree">
						...
						<li class="active">{{ __('Search Result') }}</li>
					</ul>
				</div>
			</div>
		</div>
...
<script>
    ...
    let search_keyword = "@php echo $search_product; @endphp"
    document.title = title + " - Search Results For " + search_keyword.charAt(0).toUpperCase() + search_keyword.slice(1)
