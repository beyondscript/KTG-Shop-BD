...
@section('content')
                ...
                <form method="POST" action="{{ route('custom.register') }}" enctype="multipart/form-data">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="bkashnumber" type="text" class="form-control @error('bkashnumber') is-invalid @enderror" name="bkashnumber" placeholder="Please enter the bkash number" value="{{ old('bkashnumber') }}" autocomplete="bkashnumber">
                            @error('bkashnumber')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label for="nagadnumber">{{ __('Nagad Number:') }}</label>
                            <input id="nagadnumber" type="text" class="form-control @error('nagadnumber') is-invalid @enderror" name="nagadnumber" placeholder="Please enter the nagad number" value="{{ old('nagadnumber') }}" autocomplete="nagadnumber">
                            @error('nagadnumber')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted" style="margin-bottom: 0;">{{ __('Want to be a buyer?') }}</p>
    ...
    <script>
        ...
        document.title = title + " - Seller Register"
        window.onload = function(){
            ...
            meta_keywords.content = title + ", " + title + " - Seller Register"
