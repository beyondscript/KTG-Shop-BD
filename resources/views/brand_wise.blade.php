...
<script>
    ...
    let brand = "@php echo $brand2->brandname; @endphp"
    document.title = title + " - Products For " + brand
    window.onload = function(){
        ...
        meta_keywords.content = title + " - " + brand + ", " + brand
    ...
    $(document).ready(function(){
        $('select[name="category"]').on('change', function(){
            ...
            $.ajax({
                type: 'get',
                dataType: 'html',
                url: '{{URL::to('/products-for-brand-by-category')}}',
